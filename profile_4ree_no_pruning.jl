...
@info "Training — $MAX_ITERATIONS iterations, HiGHS, Serial, NO PRUNING"
...
SDDP.train(
    ...
    cut_type = cut_type,
    cut_deletion_minimum = -1,  # Disable pruning entirely
    print_level = 2,
...
conv_path = joinpath(OUT_DIR, "profile_convergence_no_pruning.csv")
cuts_path = joinpath(OUT_DIR, "profile_node_cuts_no_pruning.csv")
